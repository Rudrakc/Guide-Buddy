...
interface QuizSectionProps {
  ...
  addAnswer: (question: string, answerMarked: string, correctAnswer: string) => void;
}
                    ...
                    <div className="mt-4 space-y-3">
                      {question.choices.map((choice, cIdx) => (
                        <button
                          ...
                          className={`w-full bg-white flex items-center p-4 rounded-lg border transition-all ${getButtonStyles(
                            isSubmitted,
                    ...
                    {selectedAnswer && !isSubmitted && (
                      <button
                        onClick={() => {
                          ...
                          addAnswer(question.question, selectedAnswer, question.correctAnswer);
                        }
                        }
